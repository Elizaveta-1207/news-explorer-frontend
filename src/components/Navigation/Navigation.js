...
function Navigation() {
  return (
    <nav className='header__nav'>
      <Link to='/' className='header__link header__link_selected_main'>
        Главная
      </Link>
      <Link
        to='/saved-news'
        className='header__link header__link_selected_saved header__link_hidden'
      >
        Сохраненные статьи
      </Link>
      <Link to='/' className='header__link header__link_auth'>
        <p className='header__item'>Елизавета</p>
        <svg
